...
function testOC(api) {
  describe('OC Remote listings', function(done) {
    let baseRoute = '/clist-remote'
    let engListings = baseRoute + '/oc-eng';
    let sofListings = baseRoute + '/oc-sof';
    let webListings = baseRoute + '/oc-web';
